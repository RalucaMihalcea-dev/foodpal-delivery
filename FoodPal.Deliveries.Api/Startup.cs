...
using FoodPal.Deliveries.Api.Filters;

namespace FoodPal.Deliveries.Api
{
    public class Startup
    {
        ...
        { 
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "FoodPal.Deliveries.Api", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "FoodPal.Deliveries.Api v1"));
            }
